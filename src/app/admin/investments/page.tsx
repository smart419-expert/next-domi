    ...
    <AppLayout>
      <div className="py-8">
        <PageTitle
          ...
          description="Visualize investment performance and portfolio data"
          size="lg"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Across 8 sectors</p>
              </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600">Monthly Return</p>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>Manage your investment data and reports</CardDescription>
          </CardHeader>
          <CardContent>
